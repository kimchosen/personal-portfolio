...
if (navUl && navLinks.length) {
  ...
  pill.className = "nav-indicator-pill absolute rounded-full pointer-events-none opacity-0 z-0";
  ...
  const initialLink = document.querySelector(`.site-nav a[href="${currentHash}"]`) || navLinks[0];
  if (initialLink) {
    setTimeout(() => {
